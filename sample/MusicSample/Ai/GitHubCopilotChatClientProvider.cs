...
///
/// Copied from the MauiUi2026 sample; registered manually in <c>MauiProgram</c> (this sample does not
/// use Shiny's DI source generator).
/// </summary>
public class GitHubCopilotChatClientProvider
{
    ...
    static readonly HttpClient Http = new()
    {
        DefaultRequestHeaders =
        {
            ...
            { "User-Agent", "ShinyMusicSample/1.0" }
        }
    };
